...
- For **reducing couplings**, list the larger trade size first, then the smaller, separated by "x" (e.g., 1"x 3/4").
- For **combination couplings**, name both raceway types in the order material typically transitions (e.g., "EMT-to-Rigid," "EMT-to-Flex"), and list both joining methods if they differ end to end.
